...
public class test_espresso_1 {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void test_espresso_demo() {
        ...
        try {    //In case user is already logged in
                logout();
                login("whiteelephant261","video1");
        }
        catch (Exception e) {   //In case user is not logged in
            login("whiteelephant261","video1");
        }
